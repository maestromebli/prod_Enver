 ...
 * 2. Інструменти → Редактор скриптів (v20+) → відкрити цей файл → Виконати.
 *    Або призначте на панель скриптів / додайте хук у GibLabExport (див. ENVER_AUTO_B3D_PATH нижче).
 * 3. Оберіть експортований .b3d — ENVER3 і .enver-assembly.json запишуться в той самий файл.
 * 4. Завантажте .b3d (і JSON, якщо окремо) у Enver — CRM допише ENVER3 автоматично.
 *
